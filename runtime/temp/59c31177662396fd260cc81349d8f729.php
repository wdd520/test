<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"E:\phpstudy\WWW\Change\public/../application/admin\view\admin\showadmin.html";i:1536735141;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <body>
    <div class="x-nav">
      ...
      <xblock>
        <button class="layui-btn" ><a href="<?php echo url('admin/addadmin'); ?>">添加</a></button>
      ...
      <table class="layui-table">
        ...
        <tbody>
            ...
            <td style="text-align: center"><?php echo $v['Id']; ?></td>
              <td><img src="/change/public/uploads/<?php echo $v['Img']; ?>"  alt="照片" width="100" height="80"/></td>
            <td style="text-align: center"><?php echo $v['Name']; ?></td>
              <td style="text-align: center"><?php echo $v['PassWord']; ?></td>
              <td style="text-align: center"><?php echo $v['StudentId']; ?></td>
              <td style="text-align: center"><?php echo $v['College']; ?></td>
              <td style="text-align: center"><?php echo $v['Professional']; ?></td>
              <td style="text-align: center"><?php echo $v['class']; ?></td>
              </td>
            <td class="td-manage" style="text-align: center">
              <a title="编辑"  href = "upadmin/id/<?php echo $v['Id']; ?>">
                <i class="layui-icon">&#xe642;</i>
              </a>
              <a title="删除" href = "deladmin/id/<?php echo $v['Id']; ?>">
                <i class="layui-icon">&#xe640;</i>
              </a>
            </td>
          </tr>
