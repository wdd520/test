<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"C:\phpStudy\WWW\Change\public/../application/home\view\order\showorder.html";i:1535620560;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<body>
		...
		<div class="concent" style="margin-top: 30px;">
				...
				<div class="logistics">
					<h3>选择支付方式</h3>
					<ul class="pay-list">
						<li class="pay card"><img src="/change/public/static/images/wangyin.jpg" />银联<span></span></li>
						<li class="pay qq"><img src="/change/public/static/images/weizhifu.jpg" />微信<span></span></li>
						<li class="pay taobao"><img src="/change/public/static/images/zhifubao.jpg" />支付宝<span></span></li>
					</ul>
				</div>
				<div class="clear"></div>
											...
											<li class="td td-item">
												<div class="item-pic">
													<a href="#" class="J_MakePoint">
														<img src="/change/public/static/images/kouhong.jpg_80x80.jpg" class="itempic J_ItemImg"></a>
												</div>
												<div class="item-info">
