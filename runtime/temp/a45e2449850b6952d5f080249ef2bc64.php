<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"E:\phpstudy\WWW\thinkphp5\public/../application/admin\view\login\login.html";i:1528356630;}*/ ?>
﻿<!DOCTYPE html>
<html lang="zh-cn">
<head>
                ...
                <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                    ...
                    <div class="form-group">
                        <div class="field">
                           ...
                           <img src="<?php echo captcha_img(); ?>" alt="" width="100" height="32" class="passcode" style="height:43px;cursor:pointer;" onclick="this.src=this.src+'?'">
