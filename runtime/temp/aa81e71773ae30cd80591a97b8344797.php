<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"E:\phpstudy\WWW\thinkphp5\public/../application/admin\view\interview\saveinter.html";i:1528616910;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
            ...
            <div class="field">
                ...
                <select name="MessengerPhone" class="input w50">
                   <?php if(is_array($listm) || $listm instanceof \think\Collection || $listm instanceof \think\Paginator): if( count($listm)==0 ) : echo "" ;else: foreach($listm as $key=>$vo): if($data['MessengerPhone'] == $vo['MessengerPhone']): ?>
                    <option value="<?php echo $vo['MessengerPhone']; ?>" selected><?php echo $vo['MgName']; ?></option>
                            <?php else: ?>
        ...
        <div class="form-group">
            ...
            <div class="field">
                <select name="MinorCardId" class="input w50">
                    ...
                    <option value="<?php echo $v['MinorCardId']; ?>" selected><?php echo $v['MnName']; ?></option>
                    <?php else: ?>
