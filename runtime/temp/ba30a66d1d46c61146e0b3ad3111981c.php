<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"C:\phpStudy\WWW\Change\public/../application/admin\view\information\addinfo.html";i:1534250709;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="x-body">
        <form class="layui-form" method="post"  enctype="multipart/form-data">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <textarea type="text"  rows="30" cols="50" name="Content"
                   class="layui-input" style="width: 200px;height: 200px"></textarea>
              </div>
          </div>
    <div class="layui-form-item">
                <label  class="layui-form-label">
