<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"C:\phpStudy\WWW\Change\public/../application/admin\view\shop\upshop.html";i:1535444292;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="x-body">
        <form class="layui-form" method="post" enctype="multipart/form-data">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text"  name="OldPrice" value="<?php echo $data['OldPrice']; ?>"
                   class="layui-input">
              </div>
          </div>
          <div class="layui-form-item">
